  ...
  <div class="order-meeting">
    <div class="inner-block">
      ...
      <div class="order-item">
        ...
        <p>{{ $t('lang.book.order.meeting.obligate') }}</p>
        <div class="data">
          <template v-if="orderData.connect.type === 'weixin'">
            <i class="iconfont icon-weixin"></i>
            {{ $t('lang.book.appt.meeting.weixin') }}
          </template>
          <template v-else>
            <i class="iconfont icon-skype"></i>
            skype
          </template>
          　　{{ $t('lang.book.order.meeting.account') }}：{{ orderData.connect.account }}
        </div>
      </div>
      <div class="order-item">
      ...
      <div class="order-item">
        ...
        <p>{{ $t('lang.book.appt.meeting.item2') }}</p>
...
<style scoped lang='less' type="text/less">
  .inner-block .order-item:nth-child(1) {
    margin-bottom: 50px;
  }
</style>
